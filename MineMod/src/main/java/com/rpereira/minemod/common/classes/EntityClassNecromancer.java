...
public class EntityClassNecromancer extends EntityClassMana {
	...
	public EntityClassNecromancer() {
		super("minemod:textures/gui/classes/necromancer.png", "necromancer", ChatColor.DARK_PURPLE);

		// add spells
		super.addSpell(MineModSpells.DRAIN);
		super.addSpell(MineModSpells.ZOMBIE_SUMMON);
