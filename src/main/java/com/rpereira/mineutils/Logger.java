...
public class Logger {
	...
	private static final DateFormat _date_format = new SimpleDateFormat("HH:mm:ss");
	...
	public void log(Logger.Level level, String message) {
		...
		this._print_stream.printf("[%s] [%s] [Thread: %s(%d)] [%s:%d] ", _date_format.format(_calendar.getTime()),
				MineSpells.NAME + "/" + level.getLabel(), thrd.getName(), thrd.getId(), trace1.getFileName(),
				trace1.getLineNumber());
